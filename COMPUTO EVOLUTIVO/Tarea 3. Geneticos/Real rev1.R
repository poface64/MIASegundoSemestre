...
optimizar = function(problema,pobsize,PC,PM,b,Dn = 10){
  ...
  if (mejorsol[1] == 0) {
    ...
    while (min(aptitudes) > 0 & contadoreval < LIM){
      ...
      elite =  poblacion[which.min(aptitudes),]
      ### 2.- Seleccionar a los padres ####
      ganadores = padreselect(poblacion,aptitudes)
      ### 3.- Operador de CRUZA
