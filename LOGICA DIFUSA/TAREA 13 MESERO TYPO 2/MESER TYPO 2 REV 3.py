...
servicio_maloMF = fz.IT2FS(servicio_dom ,
                 fz.gaussian_mf, [0, 2.5, 1],
                 fz.gaussian_mf, [0, 2, 0.5],
                 check_set=True)
...
#### Superficie para Servicio y comida fijando lugar ####
...
plt.title("Superficie fijando el lugar")
plt.tight_layout()
plt.show()

#### Superficie para Comida y lugar fijando comida ####
# Generar la malla de evaluación
...
plt.title("Superficie fijando el servicio")
plt.tight_layout()
plt.show()
