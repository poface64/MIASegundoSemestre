...
%% Cargar los datos %%
%ruta = "Fig3.37(a).png";
ruta = "Mucha_SalPimienta.png";
img = rgb2gray(imread(ruta));
imshow(img)

%% Script funcionando %%
res1 = adpmedian(img,21);
imshow(res1)

%% Script de mediana base %%
res2 = medfilt2(img,[15,15]);
imshow(res2)

%res2 = ordfilt2(img,median(1:(440*455)),ones(440,455))
